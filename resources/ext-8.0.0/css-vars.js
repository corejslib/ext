    ...
    var define, module, exports; return ( function () {
        function r ( e, n, t ) {
            function o ( i, f ) {
                if ( !n[ i ] ) {
                    if ( !e[ i ] ) {
                        var c = typeof require == "function" && require; if ( !f && c ) return c( i, !0 ); if ( u ) return u( i, !0 ); var a = new Error( "Cannot find module '" + i + "'" ); throw a.code = "MODULE_NOT_FOUND", a;
        ...
        function getJsName ( name ) {
            return name.replace( /-/gv, "_" ).replace( /\//gv, "_fs_" ).replace( /\\/gv, "_bs_" );
        }
        ...
        function ( __rt ) {
            ...
            __rt_setDynamic( "$base-pressed-color", __rt_getGlobalDefault( "$base_pressed_color" ) || __rt_box( __rt_registered.darken.apply( __rt.registered, __rt_applySpreadArgs( [
                ( __rt_test( __rt_get( "$dark_mode" ) )
                    ? __rt_box( __rt.registered.darken.apply( __rt.registered, __rt_applySpreadArgs( [
                        __rt_get( "$base_color" ),
                        new __Numeric( 15, "%" ) ] ) ) )
                    : __rt_box( __rt.registered.lighten.apply( __rt.registered, __rt_applySpreadArgs( [
                        __rt_get( "$base_color" ),
                        new __Numeric( 15, "%" ) ] ) ) ) ),
                new __Numeric( 0, "%" ) ] ) ) ), 7 );
            ...
            __rt_setDynamic( "$selected-background-color", __rt_getGlobalDefault( "$selected_background_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ...
                : __rt_box( ( __rt.functions.material_color || material_color__fn ).apply( __rt.functions, __rt_applySpreadArgs( [
                    new __Text( "grey", "'" ),
                    new __Text( "300", "'" ) ] ) ) ) ), 29 );
            ...
            __rt_setDynamic( "$overlay-color", __rt_getGlobalDefault( "$overlay_color" ) || ( __rt_test( __rt_get( "$dark_mode" ) )
                ? __rt_box( __rt.registered.rgba.apply( __rt.registered, __rt_applySpreadArgs( [
                    __ColorRGBA.fromHex( "#fff" ),
                    new __Numeric( 0.03 ),
                    __udf,
                    __udf,
